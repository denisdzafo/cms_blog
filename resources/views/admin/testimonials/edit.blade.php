                      ...
                      <form class="form-horizontal" role="form"  method="post" action="{{route ('testimonials.update',$testimonial->id)}}">
                         ...
                         <div class="form-row">
                            <div class="form-group col-md-12">
                               ...
                               <input type="text" name="author" class="form-control"  value="{{$testimonial->author}}">
                            </div>
                         </div>
                         ...
                         <div class="form-row">
                            <div class="form-group col-md-12">
                               ...
                               <textarea type="text" class="form-control" name="quote" rows="10">{{$testimonial->quote}}</textarea>
                            </div>
                         </div>
